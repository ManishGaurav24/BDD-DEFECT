...
def compare_stats(stats1, stats2, metric, sheet, row, summary):
    ...
    if rounded_diff_delta < 0:
        cell.fill = PatternFill(start_color="0c880e", end_color="0c880e",
                                fill_type="solid")  # Green for Fast (File 2 is better)
    elif rounded_diff_delta > 0:
        cell.fill = PatternFill(start_color="f4eb36", end_color="f4eb36",
                                fill_type="solid")  # Yellow for Slow (File 1 is better)
